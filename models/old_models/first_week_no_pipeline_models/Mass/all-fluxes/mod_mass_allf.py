...
phot = phot.drop(columns=['LRATIO', 'TEMP', 'LM', 'L_BOL', 'SURF_DENS', 'DIAM', 'T_BOL', 'YB'])

phot_X = phot.drop(columns=['MASS'])
phot_y = phot['MASS']
...
plt.savefig(f"mass_convergence_plot.png", dpi=300, bbox_inches='tight')

#objective plot
plot_objective(global_best_result, size=2)
plt.title(f"Objective Plot: {best_model_name}")
plt.savefig(f"mass_objective_plot.png", dpi=300, bbox_inches='tight')

# evaluation plot
plot_evaluations(global_best_result, size=2)
plt.title(f"Evaluation Plot: {best_model_name}")
plt.savefig(f"mass_evaluation_plot.png", dpi=300, bbox_inches='tight')
...
plt.savefig(f"log_mass_convergence_plot.png", dpi=300, bbox_inches='tight')

#objective plot
plot_objective(global_best_log_result, size=2)
plt.title(f"Objective Plot: {best_log_model_name}")
plt.savefig(f"log_mass_objective_plot_.png", dpi=300, bbox_inches='tight')

# evaluation plot
plot_evaluations(global_best_log_result, size=2)
plt.title(f"Evaluation Plot: {best_log_model_name}")
plt.savefig(f"log_mass_evaluation_plot.png", dpi=300, bbox_inches='tight')

import pandas as pd
from models.old_models.first_optuna_models.ratio_function import RatioGenerator, LogRatioGenerator, pinball_loss_function, check_and_expand_bounds_optuna
...
def main():
    ...
    study_name = "mult_quant_study_v2"
    storage = f"sqlite:///study_sql_files/my-{args.response}-t{args.threshold}-single_model-study.db"

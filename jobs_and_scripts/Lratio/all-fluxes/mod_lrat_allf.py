...
phot = phot.drop(columns=['LM', 'TEMP', 'MASS', 'L_BOL', 'SURF_DENS', 'DIAM', 'T_BOL', 'YB'])

phot_X = phot.drop(columns=['LRATIO'])
phot_y = phot['LRATIO']
...
for name, setup in models.items():
    print(f"{name} for log of lratio:")
...
plt.savefig(f"lrat_convergence_plot.png", dpi=300, bbox_inches='tight')

#objective plot
plot_objective(global_best_result, size=2)
plt.title(f"Objective Plot: {best_model_name}")
plt.savefig(f"lrat_objective_plot.png", dpi=300, bbox_inches='tight')

# evaluation plot
plot_evaluations(global_best_result, size=2)
plt.title(f"Evaluation Plot: {best_model_name}")
plt.savefig(f"lrat_evaluation_plot.png", dpi=300, bbox_inches='tight')
...
plt.savefig(f"log_lrat_convergence_plot.png", dpi=300, bbox_inches='tight')

#objective plot
plot_objective(global_best_log_result, size=2)
plt.title(f"Objective Plot: {best_log_model_name}")
plt.savefig(f"log_lrat_objective_plot_.png", dpi=300, bbox_inches='tight')

# evaluation plot
plot_evaluations(global_best_log_result, size=2)
plt.title(f"Evaluation Plot: {best_log_model_name}")
plt.savefig(f"log_lrat_evaluation_plot.png", dpi=300, bbox_inches='tight')

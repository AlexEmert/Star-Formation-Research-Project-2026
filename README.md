...
jobs_and_scripts: contains all my python scripts and sbatch jobs that will be sent to the Borah Cluster, sorted by physical property being predicted
...
qmd-exploration: contains a data cleaning script and other exploraroty qmd files

...
for name, setup in models.items():
    ...
    print(f"Best Score with log surface dens (not translatable): {-log_opt.best_score_:.4f}")
    print(f"Best Params with log surface dens (not translatable): {dict(log_opt.best_params_)}\n")

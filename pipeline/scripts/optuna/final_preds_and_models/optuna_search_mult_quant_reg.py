...
def main():
    ...
    def objective(trial):
        ...
        for alpha in alphas:
            ...
            loss_scores = cross_val_score(model_pipe, X_train, y_train, scoring=pinball_scorer, cv=8, n_jobs=8)
    ...
    def objective(trial):
        ...
        scores = cross_val_score(model_pipe, X_train, y_train, scoring='neg_root_mean_squared_error', cv=8, n_jobs=8)

...
phot = phot.drop(columns=['LRATIO', 'TEMP', 'LM', 'L_BOL', 'MASS', 'DIAM', 'SURF_DENS', 'YB'])

phot_X = phot.drop(columns=['T_BOL'])
phot_y = phot['T_BOL']
...
plt.savefig(f"tbol_convergence_plot.png", dpi=300, bbox_inches='tight')

#objective plot
plot_objective(global_best_result, size=2)
plt.title(f"Objective Plot: {best_model_name}")
plt.savefig(f"tbol_objective_plot.png", dpi=300, bbox_inches='tight')

# evaluation plot
plot_evaluations(global_best_result, size=2)
plt.title(f"Evaluation Plot: {best_model_name}")
plt.savefig(f"tbol_evaluation_plot.png", dpi=300, bbox_inches='tight')
...
plt.savefig(f"log_tbol_convergence_plot.png", dpi=300, bbox_inches='tight')

#objective plot
plot_objective(global_best_log_result, size=2)
plt.title(f"Objective Plot: {best_log_model_name}")
plt.savefig(f"log_tbol_objective_plot_.png", dpi=300, bbox_inches='tight')

# evaluation plot
plot_evaluations(global_best_log_result, size=2)
plt.title(f"Evaluation Plot: {best_log_model_name}")
plt.savefig(f"log_tbol_evaluation_plot.png", dpi=300, bbox_inches='tight')

...
phot = phot.drop(columns=['LM', 'T_BOL', 'SURF_DENS', 'L_BOL', 'LRATIO', 'DIAM', 'TEMP', 'YB'])
...
for name, setup in models.items():
    print(f"--- Running {name} for log of mass---")
